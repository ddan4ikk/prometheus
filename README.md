...
Кстати если вы накосячили со свармом и выше указанным деплоейм , а вы уже накосячили =) , то нужно, если не поздно, через docker rm и rmi удалить все связанные и указанные  выше контенера.
